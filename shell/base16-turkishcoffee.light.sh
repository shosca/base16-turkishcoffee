...
color_foreground="4a/2a/15" # Base 02
color_background="fd/fb/fa" # Base 07
color_cursor="4a/2a/15" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 4a2a15 # forground
  printf $printf_template_custom Ph fdfbfa # background
  printf $printf_template_custom Pi 4a2a15 # bold color
  printf $printf_template_custom Pj c17038 # selection color
  printf $printf_template_custom Pk 4a2a15 # selected text color
  printf $printf_template_custom Pl 4a2a15 # cursor
  printf $printf_template_custom Pm fdfbfa # cursor text
else
